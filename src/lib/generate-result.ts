...
// シードベースのpickRandom（スコアからシードを生成して同じ結果を保証）
function makePickRandom(seed: number): <T>(arr: readonly T[], n: number) => readonly T[] {
  const rng = createSeededRandom(seed)
  return <T>(arr: readonly T[], n: number): readonly T[] => {
    const indices = arr.map((_, i) => ({ i, r: rng() }))
    indices.sort((a, b) => a.r - b.r)
    return indices.slice(0, n).map((x) => arr[x.i] as T)
  }
}

// 単一選択もシード対応
function makePickOne(seed: number): <T>(arr: readonly T[]) => T {
  const rng = createSeededRandom(seed)
...
const MBTI_PROFILES: readonly MbtiProfile[] = [
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたが惹かれるのって『手の動き』なんだよね。タバコの吸い方、コップの持ち方、ハンドル握る指。言葉より先に手で語る人。それを観察してる時間が、もう恋の始まり。けっこうフェチっぽい愛し方してる。",
      "あなたって『説明しない人』に安心するタイプ。理由を喋らない、感情を解説しない、ただそこにいる。沈黙の中にいる相手の体温で、全部わかった気になる。たぶんあなた、言葉より体温で恋愛してる。",
      "あなたが落ちる瞬間って、相手が何にも言わずに、自分の困りごとを片付けてくれたとき。LINEで『どうしたの？』とか聞いてこない、ただ次会ったときに静かに動いてる。あの寡黙な解決力に弱い。ヒーロー願望、ちょっとある。",
    ],
    microTraits: [
      "「別に」が口癖",
      "でも迎えに来てくれる",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたって『太陽みたいな人』に惹かれるくせに、その太陽が沈む瞬間を見たいタイプだよね。みんなの前で輝いてる人が、二人きりのときに見せる影。あの落差を独占したい欲、もはや所有欲に近い。優しさで包んでくる人を、独り占めしたい。",
      "あなたが好きなのって『他人を肯定する能力が異常に高い人』だよね。誰のどんな話も真剣に聞いて、否定しないで、ちゃんと拾ってくれる。あなたはその一人になりたいから、その人の話を一番ちゃんと聞きたい。承認のキャッチボールで関係が育つタイプ。",
      "あなたって相手を喜ばせるのが上手いから、世話焼きの人と組み合わせると暴走するよね。お互いに尽くし合って、お互いに気を遣い合って、誰も本音言えなくなる。あなたの恋愛、たまに『気遣いの応酬』で疲れることない？",
    ],
    microTraits: [
      "先にご飯を取り分けてくれる",
      "体調を気にしてくる",
  ...
  // ━━━ 追加8タイプ ━━━
  {
    ...
    coreDescriptions: [
      ...
      "あなたって安定が一番ロマンチックだと思ってるタイプ。毎日同じ時間に『お疲れ』のLINEが来る、毎週土曜にスーパー行く、年に一回旅行する。あの『当たり前の繰り返し』を維持できる人を、心から尊敬してる。地味に思えて、たぶん一番難しい愛。",
      "あなたって『信頼できる人』を判別する目が異常に厳しいよね。フラグの立て方が細かい。締め切りを破らない、人の悪口を言わない、レシートを捨てない。そういう小さな積み重ねを観察して、合格点に達した人だけ恋愛対象になる。けっこう厳格な審査してる。",
      "あなたが惹かれるのって、感情で動かない人だよね。怒っても冷静、嬉しくても淡々、ピンチでも段取り通り。あの感情の安定感に、なぜか自分の感情が預けられる。預金通帳みたいな相手、それがあなたの理想。",
    ],
    microTraits: [
      "毎朝同じ時間に起きる",
      "靴がいつも綺麗",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたって『誰にも気づかれない優しさ』を見つけるのが上手いタイプ。みんなが気づかない場所で、こっそり面倒見てる人。あの隠れた献身を発見した瞬間、もう離れたくなくなる。表に出ない愛情を専門に発掘してる。",
      "派手な恋愛は苦手なくせに、地味すぎる人にも惹かれないんだよね。あなたが選ぶのって『普段は地味だけど、自分の好きなものを語るときだけキラキラする人』。誰にも見せない情熱を、自分だけが知ってる優越感に弱い。",
      "あなたが好きなのって『日常を一緒に過ごせる人』だよね。イベントじゃなくて、なんでもない火曜の夜が幸せに感じられる相手。スーパー行って、ご飯作って、テレビ見て寝る。あの何でもない時間を共有できる人が、たぶんあなたの正解。",
    ],
    microTraits: [
      "冷蔵庫の中身を把握してる",
      "記念日を忘れない",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたが惹かれるのって『判断力のスピード』だよね。レストランで5秒でメニュー決めれる、迷子になっても3秒でルート出せる。あの即決力がそのまま色気に変換されてる。優柔不断な人を恋愛対象にできないの、もう体質。",
      "リーダー気質の人が好きなのは表向き。本当は、その人が自分にだけ『どうしよう』って迷いを見せた瞬間に、最強に好きになる。みんなには決断者、自分には相談相手。あの二面性が、あなたの恋愛の最高峰。",
      "あなたが好きなのって、有言実行する人だよね。『次会うときラーメン食おう』が、ちゃんと『来週水曜どこそこ』に変換されてる人。口先だけで終わらない、約束を行動に変える人。口で愛を語る人より、予定表で愛を見せる人。",
    ],
    microTraits: [
      "予約は絶対自分でする",
      "道に迷わない",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたが惹かれるのって、人を否定しない人だよね。自分の話を真剣に聞いてくれて、リアクションが大きくて、批判しないで受け止めてくれる。あなたの中の『自己肯定感』を上げてくれる人を、本能で選んでる。",
      "誰にでも優しい人を選ぶと、毎回モヤモヤするよね。優しさが平等すぎて、自分だけのものに感じられない。だからあなたが本当にハマるのは『普段は優しいけど、自分の前だけは少し独占欲を見せる人』。優しさに『私限定』のフレーバーがついてないと、安心できない。",
      "あなたって愛情を表現してくれる頻度に、ガチで生きるエネルギー左右されてるよね。毎日『おはよう』が来るかどうかで、その日の機嫌が変わる。それくらい愛情の証明を、日々確認したいタイプ。重いって思わなくていい。あなたの言語がそれってだけ。",
    ],
    microTraits: [
      "誰かの誕生日を忘れない",
      "グループLINEの盛り上げ役",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたの恋愛、語る前に体験してるんだよね。一緒に何かやって、ノリが合うかどうかで判断する。価値観を言葉で確認する前に、行動が同調するかで決まる。だからじっくり話す前に手を繋いでる、みたいな関係になりがち。",
      "あなたって、計画通りに進む恋愛にすぐ飽きるよね。スリルがないと熱量保てない。だから喧嘩したり、距離が乱れたり、予測不能なことが起きてる方が逆に燃える。安定の中じゃ生きられない、ちょっと厄介な恋愛体質。",
      "あなたが好きなのって、肉体性のある人。スポーツしてる、よく食べる、声が大きい、よく動く。生命力のオーラに引き寄せられる。頭脳系の冷たい知性より、汗かいてる人のリアルな熱に魂が反応してる。",
    ],
    microTraits: [
      "フットワークが異常に軽い",
      "「今から行こう」が多い",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたって感情に正直な人に惚れるよね。嬉しいときは全力で喜ぶ、悲しいときは隠さず泣く。あの感情の出力が高い人と一緒だと、自分も解放される感じがする。抑圧してきた何かが、相手と一緒になら出せるタイプ。",
      "あなたが好きなのって、人前でも自分の前でも変わらない人だよね。誰の前でも素直で、裏表がない。普段から取り繕ってる人を見抜くセンサーが鋭くて、装飾ゼロの人にだけ心が動く。リアルな人にしか惚れない、シンプルな審美眼。",
      "あなたが惹かれるのって、楽しさを共有することに本気の人。一人で楽しんでも意味ない、誰かと笑う方が楽しい、って思える人。あなたの『一緒にいたい欲』に、ちゃんと応えてくれる人。一人時間より、二人時間を優先してくれる人にめっちゃ弱い。",
    ],
    microTraits: [
      "リアクションが大きい",
      "「楽しい！」をすぐ言う",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたって遊び心ある人に弱いよね。ちょっと無茶振りしてくる、変なゲーム提案してくる、退屈な日常をエンタメに変えられる人。あの『生活を楽しむ才能』に憧れちゃう。仕事できるだけの人には、たぶん3日で飽きるタイプ。",
      "あなたが好きなのって、議論で対等に渡り合える人。意見を持ってる、自分の考えを言葉にできる、反論されても怒らない。あなたを思考停止にさせない人を、本能で選んでる。沈黙で頷くだけの人は、たぶん退屈すぎて見えない。",
      "あなたって『この人何考えてるかわからない』を肯定的に捉えるタイプ。普通の人にとってはストレスになる『読めなさ』が、あなたにとっては最高のスパイス。安定を求めると死ぬ。だからわざと不安定な人を選ぶ。",
    ],
    microTraits: [
      "話が急に飛ぶ",
      "議論すると目が輝く",
  ...
  },
  {
    ...
    coreDescriptions: [
      ...
      "あなたって、人生を真剣にやってる人に惚れるよね。仕事でも趣味でも何かに打ち込んでる人。情熱の方向は何でもいい、熱量があるかどうかが全て。だから『なんとなく生きてる人』には1ミリも反応しない。情熱の波長が合う相手だけが、あなたの恋愛圏内。",
      "あなたが好きなのって『言ったことをやる人』だよね。口で語る愛情より、実績で見せる愛情。『来週これやる』って言って、ちゃんと実行する人。あなたにとっての信頼って、行動の積み重ねでしか作られない。だから言葉だけの人にはすぐ冷める。",
      "あなたって、自分と同じ温度で野心持ってる人に弱い。一緒に走れる人、上を目指す方向が同じ人。引っ張ってもらうより、横に並走したい。そして時々、相手より少し先に行きたい。けっこう競争的な愛し方してる。",
    ],
    microTraits: [
      "歩くのが早い",
      "決断が早い",
...
const CONTRADICTION_POOL: readonly ContradictionTemplate[] = [
  // 3軸以上の高精度テンプレート
  {
    ...
    specificity: 9,
    texts: [
      "あなたって毎回同じタイプ選んでるの、気づいてる？感情が読めない人を選んで、その人の壊れかけの部分を見つけた瞬間に離れられなくなる。恋愛がいつも『この人を救えるのは自分だけ』から始まって、『この人に振り回されてるのも自分だけ』で終わる。そしてまた同じタイプを選ぶ。けっこう深いループしてるよね。",
      "感情の温度が低くて、何考えてるかわからない人を選んでるよね。で、その人が誰にも見せない傷をポロッと出した瞬間、あなたの中で『この人を救えるのは自分だけ』ってフラグが立つ。そのフラグ、何回立てても飽きないよね。あなたの恋愛、毎回そこからリスタートしてる。",
      "あなたって、表面の温度が低い人ほど内側が壊れてるって信じてるとこあるよね。だから無表情に色気を感じる。冷たい人を見ると『この人、本当は泣いてるかも』って勝手に救いに行く。でもその救済欲、結局あなた自身を一番疲弊させてる。気づいてはいるはず。",
      "あなたが繰り返してるパターンってさ、たぶん『他人を救うこと』で自分の存在意義を確認してる。冷たくて、寂しさを抱えてて、不器用に見える人を見つけては救おうとする。救えなくても、救おうとした自分は残る。それがあなたの自己肯定の燃料になってる。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "あなたって昼間は一緒に黙ってるだけで満足するくせに、深夜になると急に愛情を確かめたくなるとこあるよね。昼の自分と夜の自分が、求めてる人が違う。本当にハマるのは、両方を同じ温度で受け止めてくれる人。でもそんな人ほぼいないから、いつも片方ずつ満たされて、片方ずつ飢えてる。",
      "昼の沈黙と、夜の『好きって言って』のギャップ。あれ、自分でも処理しきれてないでしょ。昼は『触れないで』、夜は『離さないで』。同じ人に両方を求めてる。あなたが欲しいのは恋人じゃなくて、24時間切り替えに付き合ってくれる翻訳者かも。",
      "あなたの愛情って、太陽光の下では小さくて、月明かりの下では膨らむタイプ。だから関係が深まるのって、いつも夜の電話とか深夜の長文LINEなんだよね。日中の自分は、夜の自分が言ったこと全部覚えてないフリしてる。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "あなたって相手のこと全部知りたいくせに、自分からは絶対踏み込まないよね。既読無視されても平気なフリしながら、相手の投稿はくまなくチェックしてる。本当に怖いのは『興味を持たれなくなること』なのに、興味を持ってることを悟られるのも怖い。けっこう矛盾を抱えてるタイプ。",
      "知りたい、でも知られたくない。近づきたい、でも踏み込まれたくない。あなたの恋愛、こういう両立しない欲求の塊で出来てる。だから観察してる時間が一番幸せで、相手に観察され返した瞬間に逃げ出したくなる。一方通行じゃないと窒息するタイプ。",
      "あなたって相手のSNSのストーリーを欠かさず見るくせに、自分の投稿は最小限なんだよね。情報の収支が完全に赤字。なんでそんなに知りたがるのに、自分は出さないのか。たぶん『把握する側』にいないと、関係をコントロールできない不安があるから。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "あなたが弱いのって『世話焼きだけど愛情表現はド下手な人』だよね。冷蔵庫に勝手にプリン入れてくるくせに『別に』とか言う人。一人でも全然生きていけるのに、あなたの生活だけは気にしてくれる。その矛盾に何度でも落ちる。たぶんそのタイプ専用のセンサーを搭載してる。",
      "あなたが好きなのって、ぶっきらぼうな顔で『これ買ってきた』って差し出してくる人。言葉では何も付け加えない。でもそれって、世界中であなただけに向けられた優しさだって、ちゃんと伝わってる。そのコード解読が、あなただけの特権。",
      "自立してて誰にも頼らない人なのに、なぜかあなたのことだけは見てる。その『例外』に弱いんだよね。100人に塩対応で、1人にだけ静かに優しい。あなたがその1人かどうかは、自分が一番よくわかってる。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "生活ちゃんとしてる人がタイプとか言うくせに、実際惹かれるのは冷蔵庫にビールしか入ってない人だよね。『この人の生活を立て直したい』っていう欲が、いつの間にか恋愛にすり替わってる。あなたの『好き』ってだいたい母性から始まってる気がする。",
      "あなたって、整いすぎた人には入る隙がないって本能でわかってるんだよね。だから生活がちょっと崩れてる人を選ぶ。洗濯物溜まってる、食事ちゃんと食べてない、夜更かしばっか。あの『欠け』があなたが入る場所になる。完璧な人は、たぶんあなたを必要としない。",
      "崩れた生活を整えてあげたい、っていうのが愛の入り口になってるタイプ。でもその人が本当に整ったら、あなたの居場所がなくなる。だから無意識に、完全には整えさせない。あなたの愛情、ちょっと矛盾してる。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "普段『うん』しか言わない人が、二人きりになった瞬間に30分喋り続けたら、あなたもう終わりだよね。他の人には見せない言葉の量を、自分にだけ見せてくれてる。その事実だけで3年は引きずれるタイプ。燃費がいいのか悪いのか、よくわかんない。",
      "口下手な人が、自分の前でだけ饒舌になる瞬間。あれが、あなたにとっての告白に近いんだよね。言葉のスイッチが入った理由が自分だって気づいた瞬間、もう逃げ場がない。普通の人なら聞き流す内容を、宝物みたいに記憶しちゃう。",
      "他人には『はい』『いいえ』の人が、自分にだけ抽象的な話を始める。その温度差を独占できる感覚に、あなたは本気で酔える。会話の量より、会話の希少性。誰にも共有されない言葉を、自分だけが受け取ってる事実。",
    ],
  },
  {
    ...
    specificity: 9,
    texts: [
      "あなたの恋愛、だいたい深夜2時以降に進展してるよね。『眠れない』から始まるLINE、夜にだけ崩れる相手の壁、深夜のテンションで送る長文。朝になると『なんであんなこと書いたんだろ』って思うくせに、また夜が来ると同じことしてる。あなたにとって太陽がちょっと敵。",
      "あなたの恋って、24時間のうち18時から朝4時の間にしか発生してないんじゃない？昼間の関係性とは別人みたいになる夜。送信した瞬間に後悔する文章。でも消せない。あの『夜の自分』を相手も受け止めてくれるかどうかが、関係の境界線。",
      "深夜の電話で本音が出る、深夜のLINEで距離が縮まる、深夜のドライブで好きが確定する。あなたの恋愛、ほぼ夜行性。朝起きると別人になる相手の顔を見るたび、また夜が来てくれって祈ってる。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "クールな人が好きとか公言しつつ、無邪気にはしゃいでる人を見ると心拍上がるよね。矛盾してるように見えるけど、本当に弱いのは『普段クールなのに自分の前でだけテンションおかしくなる人』。そのギャップ、一回見たら最後だよね。",
      "あなたが本当に弱いのは『二面性』。みんなの前ではクールで近寄りがたいのに、自分の前ではバカっぽくはしゃぐ人。あの切り替えを自分が引き起こしてる、っていう感覚に酔ってる。要するに、相手の人格変化のトリガーになりたいタイプ。",
      "あなたって、クールで完成されてる人を選ぶくせに、その完成を自分の前だけで崩してほしいと思ってるよね。一貫性のある人より、自分の前でだけ揺らぐ人。その揺らぎを記録して、宝物にしてる。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "3日既読無視されても『まあそういう人だし』って待てるよね。それって強さじゃなくて、期待しないことで傷つくリスクを下げてるだけかも。だから3日後に急に『今から会える？』が来たとき、全防御が一瞬で崩壊する。そしてまた3日待つ。待機時間の方が長い恋愛してる。",
      "あなたの恋愛、ほぼ『待ち時間』で構成されてる。連絡来ない時間、距離取られる時間、無視される時間。その積み重ねの後に来る一発の『会いたい』で、全部チャラになる。ちょっとパチンコ的な強化学習されてるかも。",
      "あなたが好きなのって、簡単に手に入らない人。返信が遅い、予定が読めない、急に消える。あの不安定さに振り回されてる時間こそが、あなたにとっては『恋してる時間』。安定したら、なぜか冷める。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "一人で完結してる人が好きなくせに、その人が『お前のことだけは放っておけない』みたいな空気出したとき、一発で持ってかれるよね。あなたが欲しいのは束縛じゃなくて『選ばれた感覚』。100人の中から自分だけ選ばれる、あの特別感にめちゃくちゃ弱い。",
      "誰にも頼らない人が、自分にだけは『一緒にいてもいい』と思ってくれる。あの『例外的な特権』に、あなたは脳ごと持ってかれる。一般的な恋人ポジションじゃ満たされなくて、相手の中の例外項目になりたいタイプ。",
      "自分の世界がある人ほど、その世界に入れてもらえたときの優越感がでかい。あなたが選ぶ人って、入り口が狭いんだよね。狭い扉を自分のために開けてくれた瞬間、もう離れたくなくなる。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "あなたが好きなのって、店員さんに『ありがとうございます』ってちゃんと言えるのに、感情を言葉にするのは壊滅的に下手な人だよね。他人には優しくできるのに、一番近い人には不器用になる。その不器用さを『本物の感情』だと読み取っちゃうタイプ。たぶんその読みは合ってる。",
      "他人には完璧な礼儀正しさを発揮するのに、好きな人にだけは目を合わせられない。あなたが信じるのは、その『不器用さの差分』。誰にでも優しい人は信じないけど、自分にだけ挙動不審になる人は本物だと思える。",
      "あなたって、優しさの『外向き出力』と『内向き出力』にギャップがある人に弱い。みんなには100点の対応、自分には50点の挙動。でもその50点に込められた緊張こそが、本物の証だって読んでる。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "一緒にいるのに別々のことしてる時間が一番好きなタイプだよね。でも本当はその沈黙の中で、相手が何を考えてるか全部知りたい。近づきたいのに近づけない。理想の距離が『手を伸ばせば届くけど伸ばさない距離』。絶妙すぎて、たぶん相手は気づいてない。",
      "沈黙が苦じゃない関係を求めるくせに、その沈黙の中で相手の感情を読み取り続けてる。何も話してないのに、頭の中はフル回転。あなたの『静かな時間』は、たぶん相手より忙しい。",
      "近づきすぎず、離れすぎず。同じ部屋にいて、別々のことをしてて、たまに目が合う。あなたの理想の距離、文章にすると簡単だけど、実現するのは難易度Sランク。だから合う人が見つからない。",
    ],
  },
  {
    ...
    specificity: 8,
    texts: [
      "壊れかけの人に惹かれる自覚あるよね。でもやめられない。『大丈夫？』って聞いて『大丈夫』って返されても、大丈夫じゃないのがわかっちゃう。その『わかってしまう自分』にちょっと酔ってる部分もあって、それが本気の愛情なのか自分でもわかんなくなってる。一回冷静になった方がいいかも。",
      "あなたって、メンタルが不安定な人を選ぶくせに、その人に安定を求めるよね。矛盾してるんだけど、自分でも止められない。情緒の波が激しい人と一緒にいると、自分が必要とされてる気がする。その依存、けっこう深いとこまで来てる。",
      "脆い人を愛したい欲があるよね。でもその愛し方が、相手をさらに脆くさせてる可能性、考えたことある？救いたいのか、救う側でいたいのか。その自問自答を止められない限り、たぶん同じ恋愛繰り返す。",
    ],
  },
  // MBTI次元を使った条件
  {
    ...
    specificity: 7,
    texts: [
      "あなたって自由で内向的な人、選びがちだよね。ノープランで深夜に散歩できる人、既読つけるタイミングが読めない人、気まぐれだけど一緒にいると不思議と落ち着く人。その『読めなさ』を退屈しない理由にしてるけど、本当はちょっと振り回されたいだけかも。",
      "気まぐれで一人時間が長い人に惹かれるよね。連絡くれるタイミングが完全にランダムで、急に夜中に呼び出してくる。あの予測不能さがあなたの退屈を埋めてる。でも結局、相手のペースに合わせ続けてる自分にも気づいてる。",
      "あなたが好きなのって、社会のリズムから少しズレてる人。みんなが寝てる時間に起きてて、みんなが起きてる時間に寝てる。あのズレた周波数に共鳴できる自分が、ちょっと誇らしいタイプ。",
    ],
  },
  {
    ...
    specificity: 7,
    texts: [
      "しっかりしてて社交的な人がタイプなくせに、惹かれるのはその人の『完璧じゃない部分』だよね。予定は全部組んでくれるのに、自分の感情だけは組み立てられない。そのほころびを見つけた瞬間が、恋の始まり。毎回そこからスタートしてる。",
      "見た目はちゃんとしてて、計画性もあって、社会的にも完璧。なのに恋愛になると急にポンコツ化する人。あの『得意分野と苦手分野の落差』に、あなたの心が反応する。",
      "リーダー的な人が、自分の前でだけ言葉に詰まる。あの瞬間、あなたは静かに勝利してる。普段は完璧に動くのに、感情の処理だけは下手な人。その不器用さに、特別感を勝手に乗せちゃうタイプ。",
    ],
  },
  {
    ...
    specificity: 7,
    texts: [
      "あなたが選ぶのって、内に秘めたものが多い人だよね。整理された部屋、静かな会話、でもその奥にある膨大な感情の蓄積。それを一つずつ開けていきたいタイプ。相手にとっての『なんでそこまでわかるの』が、あなたにとっての最高の褒め言葉。",
      "あなたって、相手の中に『開けられてないドア』があるって信じてる人。表面は静かでも、その奥にはまだ知らない世界がある。そのドアの鍵を一つずつ見つける作業が、あなたにとっての恋愛。",
      "自分の感情を整理して内側に持ってる人に惹かれるよね。雑に喋らない、感情をばら撒かない、奥に持ってる。だからこそ、その奥に届きたいって欲がすごい。深いとこまで降りていける関係を求めてる。",
    ],
  },
  {
    ...
    specificity: 7,
    texts: [
      "感情をストレートにぶつけてくる人にめっちゃ弱いよね。『好き』を迷わず言える人、思いつきで迎えに来る人。自分では絶対それができないから、やってくれる人に何度でも落ちる。計算じゃない感情に飢えてるんだよね。だって自分が計算しちゃうタイプだから。",
      "あなたの恋愛って、相手の感情表現の暴力性に救われてる側面あるよね。重い、ストレート、迷いがない。普通だったら引くレベルの愛情を、なぜか抵抗なく受け取れる。たぶんそれだけ、隠さない感情に飢えてた。",
      "あなたって、自分から愛情表現するのは苦手なのに、相手から浴びるのは大歓迎なタイプ。受け取り専門の恋愛モード。それでうまく回ってるなら、たぶん正解。無理に出力増やそうとしなくていい。",
    ],
  },
  // 2軸（フォールバック用、まだ十分特徴的）
  {
    ...
    specificity: 5,
    texts: [
      "感情を全部見せない人に惹かれつつ、その人からちゃんと『好き』を言ってもらいたい、ってけっこう注文の多いタイプ。結局選ぶのは、99回無表情で1回だけ不意に感情をこぼす人。その1回のために99回の無表情を待てるの、ある意味才能だと思う。",
      "あなたって、無表情の中の1ミリの感情を読み取るプロ。だから普通の人が『この人何考えてるかわからない』って諦める相手の中に、ちゃんと愛情を見つけられる。希少な能力。でもその能力がない人と付き合ったら、たぶん3日で物足りない。",
      "クールな人を選んで『好き』をもらうのが趣味になってない？99回の塩対応に耐えて、1回の優しさで全部許す。それ、見方を変えると本当に対等な関係なのか怪しい。たまには対等な人選んでみてもいいかも。",
    ],
  },
  {
    ...
    specificity: 5,
    texts: [
      "ちょっと危うい人に惹かれるくせに、その人の面倒を見たがるよね。あなたの恋愛には常に『保護者』と『共犯者』の二面性がある。崩れてる生活を立て直してあげたいくせに、立て直されたらちょっと物足りなくなる。相手が完成する前のバージョンが好きなんだよね。けっこう独特なツボしてる。",
      "崩れてる人を整えるのが好きなくせに、整いきった瞬間に興味が薄れる。あなたが愛してるのは『完成途中』。プロセスが恋愛で、完成は終わり。だから無意識に、相手を完成させない選び方をしてる。",
      "あなたって、相手の危うい部分を直したいのか、その危うさに惚れてるのか、自分でも切り分けられてないとこある。世話焼きと共犯者を行ったり来たりして、結局相手の人生に深く絡む。だいたい疲れる頃に気づく。",
    ],
  },
  {
    ...
    specificity: 5,
    texts: [
      "不器用な人が好きなくせに、LINEではちゃんと気持ち伝えてほしいって、けっこう難しい注文してるよね。対面では『うん』しか言えないのに、夜中に3行の長文が来る。あなたにとっての『愛されてる実感』って、その3行なんだよね。短いけど重い、あの感じ。",
      "あなたって、対面とテキストでギャップある人に弱い。会うと無口、文字だと饒舌。同じ人が別の人格を生きてるみたいに見える。その『文字の自分』があなたにだけ向けられてる感が、依存スイッチを押す。",
      "口下手な人が頑張って書いた長文LINE、あれってあなたにとって告白とほぼ同義だよね。短文の『おやすみ』とは別物。本人が苦手分野で頑張った痕跡を、ちゃんと評価できる読解力がある。",
    ],
  },
]
...
function pickTextSeeded(
  template: ContradictionTemplate,
  rng: () => number
): string {
  const pool = template.texts
  if (pool.length === 0) return ""
  return pool[Math.floor(rng() * pool.length)] ?? pool[0]
}

function selectContradictions(
  ...
  if (matched.length >= 2) {
    return [pickTextSeeded(matched[0], rng), pickTextSeeded(matched[1], rng)]
  }
  if (matched.length === 1) {
    return [pickTextSeeded(matched[0], rng)]
  }
...
export function generateResult(
  ...
  // 同じスコアなら同じ結果になるよう、シードを生成
  const seed = hashScores(scores)
  const pickRandom = makePickRandom(seed)
  const pickOne = makePickOne(seed + 1)

  // 1. Core Analysis
  const coreAnalysis = selectContradictions(scores, seed)
  ...
  // 3. MBTI Analysis (top 4) - 決定論的選択
  const mbtiAnalysis = top4.map(({ profile }) => ({
    type: profile.type,
    trait: pickOne(profile.traits),
    description: pickOne(profile.coreDescriptions),
  }))
  ...
  const mbtiRanking = top4.map(({ profile }) => ({
    type: profile.type,
    label: profile.label,
    reason: pickOne(profile.coreDescriptions),
  }))
