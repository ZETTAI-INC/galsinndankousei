    ...
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center px-8 py-20">
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="title-editorial animate-blur-in mb-10 text-[36px] sm:text-[42px]">
            気になるあの人、
            <br />
            <em>どんなタイプ？</em>
          </h1>
    ...
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center px-8 py-20">
        <div className="w-full max-w-md text-center" key={animKey}>
          ...
          <h2 className="serif animate-fade-in-up mb-8 text-[24px] font-light leading-[1.7] tracking-wide text-white">
            診断する相手の
            <br />
            名前 or ニックネーム
          </h2>
    ...
    <div className="flex min-h-dvh flex-col items-center justify-center px-6">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between border-b border-white/5 bg-[#0a0810]/80 px-6 py-4 backdrop-blur-xl">
        {currentIndex > 0 ? (
          ...
          <span className="text-[11px] tracking-wide text-[var(--accent)]/60">
            {displayName} を診断中
          </span>
        )}
